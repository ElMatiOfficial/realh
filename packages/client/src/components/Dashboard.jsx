    ...
    <div className="space-y-8">
      <header className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-400">Manage your verification status and credentials.</p>
        </div>
        {userData?.isVerified && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col justify-center items-center text-center">
          ...
          <div className="text-3xl font-bold text-white mb-1">{userData?.credentialCount || 0}</div>
